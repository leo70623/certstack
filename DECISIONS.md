...
| 2026-09-13 | 新增 `entry_status` 欄位，區分 stub 與 complete | 部分法域（阿聯、沙烏地、中國）官方來源無法自動擷取或需付費取得，若無中間狀態，將導致為通過驗證而降低資料標準，或放棄建檔而失去涵蓋範圍上的差異化 | 一律等資料齊備才建檔（已否決，會使中東與亞洲法域長期缺漏） |
